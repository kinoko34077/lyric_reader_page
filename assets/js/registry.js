...
export function resolvePresentation(presentation = {}, registry = {}) {
  ...
  if (resolvedFontName && normalized.fonts[resolvedFontName]) { resolved.fontName = resolvedFontName; resolved.fontDefinition = clone(normalized.fonts[resolvedFontName]); resolved.font = { type: "remote", url: normalized.fonts[resolvedFontName].url, family: `ReaderFont-${resolvedFontName}` }; }
